# Generated by Django 6.0.8 on 2026-08-28 19:48
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("github_core", "0003_self_tier_vocabulary"),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("before_sha", models.CharField(blank=True, default="", max_length=64)),
                ("after_sha", models.CharField(blank=True, default="", max_length=64)),
                ("pushed_at", models.DateTimeField(blank=True, null=True)),
                ("bypassed_rules", models.JSONField(blank=True, default=list)),
            ...
            options={
                "verbose_name": "historical rule suite",
                "verbose_name_plural": "historical rule suites",
